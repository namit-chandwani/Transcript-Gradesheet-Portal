...
class TranscriptResource(resources.ModelResource):
    class Meta:
        model = Transcript
        fields = ('bitsID', 'refNo','name','phone_number','corrEmail','gradStatus','hostel','roomNo','ps2Station','origTranscript','dupTranscripts','forwardingLetters','sealedCopies','amtcal','paidAmount','postalAddressLocation','postalAddress','remarks','paymentApproved','paymentDisapproved','paymentInprocess','approved','disapproved','printed','posted','inprocess')
        export_order = ('bitsID', 'refNo','name','phone_number','corrEmail','gradStatus','hostel','roomNo','ps2Station','origTranscript','dupTranscripts','forwardingLetters','sealedCopies','amtcal','paidAmount','postalAddressLocation','postalAddress','remarks','paymentApproved','paymentDisapproved','paymentInprocess','approved','disapproved','printed','posted','inprocess')
